...
var MockState = primitives.State{
	...
	Slot:                          123,
	EpochIndex:                    123,
	ProposerQueue:                 []uint64{1, 2, 3, 4, 5, 6, 7, 8, 9},
	PreviousEpochVoteAssignments:  []uint64{1, 2, 3, 4, 5, 6, 7, 8, 9},
	CurrentEpochVoteAssignments:   []uint64{1, 2, 3, 4, 5, 6, 7, 8, 9},
	NextProposerQueue:             []uint64{1, 2, 3, 4, 5, 6, 7, 8, 9},
	JustificationBitfield:         123,
	FinalizedEpoch:                123,
	LatestBlockHashes:             [][32]byte{*Hash, *Hash, *Hash, *Hash, *Hash},
	JustifiedEpoch:                15,
