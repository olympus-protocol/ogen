...
sszgen -path ./pkg/p2p/msg_block.go -include ./pkg/primitives/block.go,./pkg/primitives/blockheader.go,./pkg/primitives/votes.go,./pkg/primitives/tx.go,./pkg/primitives/multi_signature_tx.go,./pkg/primitives/deposit.go,./pkg/primitives/exit.go,./pkg/primitives/slashing.go,./pkg/primitives/governance_votes.go,./pkg/bls/multisig/multisig.go,./pkg/burnproof/burnproof.go,./pkg/primitives/partialexit.go,./pkg/primitives/execution.go
...
sszgen -path ./pkg/p2p/msg_execution.go
...
sszgen -path ./pkg/p2p/msg_multi_signature_tx.go -include ./pkg/primitives/multi_signature_tx.go,./pkg/bls/multisig/multisig.go
sszgen -path ./pkg/primitives/block.go -include ./pkg/bls/multisig/multisig.go,./pkg/primitives/votes.go,./pkg/primitives/blockheader.go,./pkg/primitives/tx.go,./pkg/primitives/multi_signature_tx.go,./pkg/primitives/deposit.go,./pkg/primitives/exit.go,./pkg/primitives/slashing.go,./pkg/primitives/governance_votes.go,./pkg/bls/multisig/multisig.go,./pkg/burnproof/burnproof.go,./pkg/primitives/partialexit.go,./pkg/primitives/execution.go
...
sszgen -path ./pkg/primitives/multi_signature_tx.go -include ./pkg/bls/multisig/multisig.go
...
sszgen -path ./pkg/primitives/execution.go
sszgen -path ./pkg/bls/multisig/multisig.go
sszgen -path ./pkg/burnproof/burnproof.go -objs CoinsProofSerializable
