...
mkdir -p api/proto_def/protoc-gen-swagger/options/
...
curl https://raw.githubusercontent.com/grpc-ecosystem/grpc-gateway/master/protoc-gen-swagger/options/annotations.proto > api/proto_def/protoc-gen-swagger/options/annotations.proto
curl https://raw.githubusercontent.com/grpc-ecosystem/grpc-gateway/master/protoc-gen-swagger/options/openapiv2.proto > api/proto_def/protoc-gen-swagger/options/openapiv2.proto
...
rm -rf api/proto_def/protoc-gen-swagger
