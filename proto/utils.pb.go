...
func (x *GenValidatorKeys) GetPassword() string {
	if x != nil {
		return x.Password
	}
	return ""
...
var file_utils_proto_rawDesc = []byte{
	...
	0x6d, 0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x26, 0x0a, 0x08, 0x50, 0x61, 0x73,
	...
	,
...
var file_utils_proto_goTypes = []interface{}{
	...
	(*GenValidatorKeys)(nil), // 1: GenValidatorKeys
	(*Empty)(nil),            // 2: Empty
...
var file_utils_proto_depIdxs = []int32{
	0, // 0: Utils.StartProposer:input_type -> Password
	2, // 1: Utils.StopProposer:input_type -> Empty
	1, // 2: Utils.GenValidatorKey:input_type -> GenValidatorKeys
	3, // 3: Utils.SubmitRawData:input_type -> RawData
	3, // 4: Utils.DecodeRawTransaction:input_type -> RawData
	3, // 5: Utils.DecodeRawBlock:input_type -> RawData
	4, // 6: Utils.StartProposer:output_type -> Success
	4, // 7: Utils.StopProposer:output_type -> Success
	5, // 8: Utils.GenValidatorKey:output_type -> KeyPairs
	4, // 9: Utils.SubmitRawData:output_type -> Success
	6, // 10: Utils.DecodeRawTransaction:output_type -> Tx
	7, // 11: Utils.DecodeRawBlock:output_type -> Block
...
type UtilsClient interface {
	...
	StartProposer(ctx context.Context, in *Password, opts ...grpc.CallOption) (*Success, error)
	//*
	//Method: StopProposer
	//Input: message Password
	//Response: message Success
...
func (c *utilsClient) StartProposer(ctx context.Context, in *Password, opts ...grpc.CallOption) (*Success, error) {
	out := new(Success)
...
type UtilsServer interface {
	...
	//Response: message Success
	//Description: Decrypts the Keystore and starts voting/proposing.
	StartProposer(context.Context, *Password) (*Success, error)
	//*
	//Method: StopProposer
	//Input: message Password
	//Response: message Success
...
func (*UnimplementedUtilsServer) StartProposer(context.Context, *Password) (*Success, error) {
...
func _Utils_StartProposer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UtilsServer).StartProposer(ctx, req.(*Password))
	}
