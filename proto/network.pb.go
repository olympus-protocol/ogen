...
type NetworkInfo struct {
	...
	Peers    uint32 `protobuf:"varint,1,opt,name=peers,proto3" json:"peers"`
	Protocol uint32 `protobuf:"varint,2,opt,name=protocol,proto3" json:"protocol"`
...
func (x *NetworkInfo) GetPeers() uint32 {
	if x != nil {
		return x.Peers
	}
	return 0
...
func (x *NetworkInfo) GetProtocol() uint32 {
	if x != nil {
		return x.Protocol
	}
	return 0
...
var file_network_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x05, 0x70, 0x65, 0x65, 0x72, 0x73,
	0x12, 0x1a, 0x0a, 0x08, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x18, 0x02, 0x20, 0x01,
	0x28, 0x0d, 0x52, 0x08, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x12, 0x18, 0x0a, 0x07,
