...
type Tx struct {
	...
	FromPublicKey string `protobuf:"bytes,3,opt,name=from_public_key,json=fromPublicKey,proto3" json:"from_public_key"`
	...
	Fee           uint64 `protobuf:"varint,6,opt,name=fee,proto3" json:"fee"`
