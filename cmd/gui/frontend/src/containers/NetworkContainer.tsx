        ...
        return (
            <div id="network" className="page-container">
                    ...
                    <div className="col network-info">
                        <div className="row">
                            <div className="col abs-center">
                                <div>
                                    <p>Block Height <span>273,762</span></p>
                                    <p>Network Participation <span>75%</span></p>
                                    <p>No. of Validators <span>0/128</span></p>
                                </div>
                            </div>
                            <div className="col abs-center">
                                <div>
                ...
                <div className="validators">
                    ...
                    <div className="row">
                        <Validator balance={100} publicKey={1314234234333313143}
                            epoch={412} status="active" />
                        <Validator balance={100} publicKey={1314234234333313143}
                            epoch={412} status="starting" />
                        <Validator balance={100} publicKey={1314234234333313143}
                            epoch={412} status="error" />
                    </div>
                </div>
            </div>
        );
