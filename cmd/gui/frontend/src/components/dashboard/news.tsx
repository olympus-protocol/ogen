      ...
      <div className="dashboard-news dashboard-item-alt">
        ...
        <div className="row">
          <div className="dashboard-news-item-main">
            <div>
              <img
                src="https://polispay.org/wp-content/uploads/2020/09/1qZoZFv8RJLoQPrjGXuwctg.png"
                alt="main"
              />
            </div>
            <div className="abs-center">
              <div className="dashboard-news-item-main-text">
                <p className="dashboard-news-item-main-title">
                  Polis Core 1.6.4 Mandatory Update
                </p>
        ...
        <div className="row">
          <div className="dashboard-news-item">
            <span className="dashboard-news-item-title">
              Polis Core 1.6.4 Mandatory Update
            </span>
