    ...
    return (
        <div id="tx-history" className="wallet-container">
            <div className="input-group mb-3">
                <label className="mr-3 mt-2" htmlFor="txSearch">Search</label>
                <input type="text" className="form-control" placeholder="Look by date, transaction type, address, label, etc..."
                    aria-label="txSearch" aria-describedby="txSearch" />
