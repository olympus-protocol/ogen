...
// getKeyHash mocks base method
func (m *MockDatabase) getKeyHash(key []byte) (chainhash.Hash, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "getKeyHash", key)
	ret0, _ := ret[0].(chainhash.Hash)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// getKeyHash indicates an expected call of getKeyHash
func (mr *MockDatabaseMockRecorder) getKeyHash(key interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "getKeyHash", reflect.TypeOf((*MockDatabase)(nil).getKeyHash), key)
}

// getKey mocks base method
func (m *MockDatabase) getKey(key []byte) ([]byte, error) {
	m.ctrl.T.Helper()
...
func (mr *MockDatabaseMockRecorder) getKey(key interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "getKey", reflect.TypeOf((*MockDatabase)(nil).getKey), key)
}

// setKeyHash mocks base method
func (m *MockDatabase) setKeyHash(key []byte, to chainhash.Hash) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "setKeyHash", key, to)
	ret0, _ := ret[0].(error)
	return ret0
}

// setKeyHash indicates an expected call of setKeyHash
func (mr *MockDatabaseMockRecorder) setKeyHash(key, to interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "setKeyHash", reflect.TypeOf((*MockDatabase)(nil).setKeyHash), key, to)
}

// setKey mocks base method
func (m *MockDatabase) setKey(key, to []byte) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "setKey", key, to)
	ret0, _ := ret[0].(error)
	return ret0
}

// setKey indicates an expected call of setKey
func (mr *MockDatabaseMockRecorder) setKey(key, to interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "setKey", reflect.TypeOf((*MockDatabase)(nil).setKey), key, to)
}
