...
func (m *MockStateService) setFinalizedHead(finalizedHash chainhash.Hash, finalizedState primitives.State) error {
	m.ctrl.T.Helper()
...
func (m *MockStateService) GetFinalizedHead() (*chainindex.BlockRow, primitives.State) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetFinalizedHead")
	ret0, _ := ret[0].(*chainindex.BlockRow)
	ret1, _ := ret[1].(primitives.State)
	return ret0, ret1
}
...
func (m *MockStateService) GetJustifiedHead() (*chainindex.BlockRow, primitives.State) {
	m.ctrl.T.Helper()
...
func (m *MockStateService) setJustifiedHead(justifiedHash chainhash.Hash, justifiedState primitives.State) error {
	m.ctrl.T.Helper()
...
func (m *MockStateService) initChainState(db blockdb.DB, params params.ChainParams, genesisState primitives.State) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "initChainState", db, params, genesisState)
	ret0, _ := ret[0].(error)
	return ret0
}

// initChainState indicates an expected call of initChainState
func (mr *MockStateServiceMockRecorder) initChainState(db, params, genesisState interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "initChainState", reflect.TypeOf((*MockStateService)(nil).initChainState), db, params, genesisState)
}

// GetStateForHash mocks base method
func (m *MockStateService) GetStateForHash(hash chainhash.Hash) (primitives.State, bool) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetStateForHash", hash)
	ret0, _ := ret[0].(primitives.State)
	ret1, _ := ret[1].(bool)
	return ret0, ret1
}
...
func (m *MockStateService) GetStateForHashAtSlot(hash chainhash.Hash, slot uint64, view primitives.BlockView, p *params.ChainParams) (primitives.State, []*primitives.EpochReceipt, error) {
	m.ctrl.T.Helper()
...
func (m *MockStateService) Add(block *primitives.Block) (*primitives.State, []*primitives.EpochReceipt, error) {
	m.ctrl.T.Helper()
...
func (m *MockStateService) TipState() primitives.State {
	m.ctrl.T.Helper()
...
func (m *MockStateService) TipStateAtSlot(slot uint64) (primitives.State, error) {
	m.ctrl.T.Helper()
...
func (m *MockStateService) initializeDatabase(txn blockdb.DBUpdateTransaction, blockNode *chainindex.BlockRow, state primitives.State) error {
	m.ctrl.T.Helper()
...
func (m *MockStateService) setBlockState(hash chainhash.Hash, state *primitives.State) {
	m.ctrl.T.Helper()
