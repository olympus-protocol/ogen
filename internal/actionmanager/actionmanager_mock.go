...
func (m *MockLastActionManager) NewTip(row *chainindex.BlockRow, block *primitives.Block, state *primitives.State, receipts []*primitives.EpochReceipt) {
	m.ctrl.T.Helper()
...
func (m *MockLastActionManager) StartValidator(valPub [48]byte, sign func(*ValidatorHelloMessage) *bls.Signature) bool {
	m.ctrl.T.Helper()
