...
var file_chainrpc_proto_validators_proto_rawDesc = []byte{
	...
	0x73, 0x74, 0x72, 0x79, 0x12, 0x32, 0x0a, 0x0a, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x6f,
	0x72, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x56, 0x61, 0x6c, 0x69, 0x64,
	0x61, 0x74, 0x6f, 0x72, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x72, 0x79, 0x52, 0x0a, 0x56, 0x61,
	...
	,
...
var file_chainrpc_proto_validators_proto_depIdxs = []int32{
	...
	4, // 1: Validators.ValidatorsList:input_type -> Empty
	...
	0, // 5: Validators.ValidatorsList:output_type -> ValidatorsRegistry
...
type ValidatorsClient interface {
	ValidatorsList(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*ValidatorsRegistry, error)
...
func (c *validatorsClient) ValidatorsList(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*ValidatorsRegistry, error) {
	out := new(ValidatorsRegistry)
	err := c.cc.Invoke(ctx, "/Validators/ValidatorsList", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ValidatorsServer interface {
	ValidatorsList(context.Context, *Empty) (*ValidatorsRegistry, error)
...
func (*UnimplementedValidatorsServer) ValidatorsList(context.Context, *Empty) (*ValidatorsRegistry, error) {
...
func _Validators_ValidatorsList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ValidatorsServer).ValidatorsList(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Validators/ValidatorsList",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ValidatorsServer).ValidatorsList(ctx, req.(*Empty))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _Validators_ValidatorsList_Handler,
		},
		{
