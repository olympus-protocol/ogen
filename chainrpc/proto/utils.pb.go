...
var file_chainrpc_proto_utils_proto_rawDesc = []byte{
	...
	0x6d, 0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0xf0, 0x01, 0x0a, 0x05, 0x55, 0x74,
	...
	,
...
var file_chainrpc_proto_utils_proto_depIdxs = []int32{
	...
	0, // 1: Utils.GenKeyPair:input_type -> Empty
	0, // 2: Utils.GenRawKeyPair:input_type -> Empty
	1, // 3: Utils.SendRawTransaction:input_type -> RawData
	1, // 4: Utils.DecodeRawTransaction:input_type -> RawData
	1, // 5: Utils.DecodeRawBlock:input_type -> RawData
	2, // 6: Utils.GenValidatorKey:output_type -> KeyPair
	2, // 7: Utils.GenKeyPair:output_type -> KeyPair
	2, // 8: Utils.GenRawKeyPair:output_type -> KeyPair
	3, // 9: Utils.SendRawTransaction:output_type -> Success
	4, // 10: Utils.DecodeRawTransaction:output_type -> Tx
	5, // 11: Utils.DecodeRawBlock:output_type -> Block
...
type UtilsClient interface {
	...
	//Input: message Empty
	//Response: message KeyPair
	//Description: Returns a public and private keypair on bech32 format.
	GenKeyPair(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*KeyPair, error)
	//*
	//Method: GenRawKeyPair
	//Input: message Empty
	//Response: message KeyPair
	//Description: Returns a serialized bls keypair.
	GenRawKeyPair(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*KeyPair, error)
	//*
...
func (c *utilsClient) GenRawKeyPair(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*KeyPair, error) {
	out := new(KeyPair)
	err := c.cc.Invoke(ctx, "/Utils/GenRawKeyPair", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UtilsServer interface {
	...
	//Response: message KeyPair
	//Description: Returns a serialized bls keypair.
	GenRawKeyPair(context.Context, *Empty) (*KeyPair, error)
	//*
	//Method: SendRawTransaction
	//Input: message RawData
	//Response: message Success
...
func (*UnimplementedUtilsServer) GenRawKeyPair(context.Context, *Empty) (*KeyPair, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GenRawKeyPair not implemented")
}
...
func _Utils_GenRawKeyPair_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UtilsServer).GenRawKeyPair(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Utils/GenRawKeyPair",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UtilsServer).GenRawKeyPair(ctx, req.(*Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Utils_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GenRawKeyPair",
			Handler:    _Utils_GenRawKeyPair_Handler,
		},
		{
