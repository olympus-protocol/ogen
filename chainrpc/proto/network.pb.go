...
var file_chainrpc_proto_network_proto_rawDesc = []byte{
	...
	,
...
var file_chainrpc_proto_network_proto_depIdxs = []int32{
	...
	3, // 3: Network.Add:input_type -> IP
	3, // 4: Network.Ban:input_type -> IP
	0, // 5: Network.GetNetworkInfo:output_type -> NetworkInfo
	1, // 6: Network.GetPeersInfo:output_type -> Peers
	5, // 7: Network.Add:output_type -> Success
	5, // 8: Network.Ban:output_type -> Success
...
type NetworkClient interface {
	...
	Add(ctx context.Context, in *IP, opts ...grpc.CallOption) (*Success, error)
	Ban(ctx context.Context, in *IP, opts ...grpc.CallOption) (*Success, error)
}
...
func (c *networkClient) Add(ctx context.Context, in *IP, opts ...grpc.CallOption) (*Success, error) {
	out := new(Success)
	err := c.cc.Invoke(ctx, "/Network/Add", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *networkClient) Ban(ctx context.Context, in *IP, opts ...grpc.CallOption) (*Success, error) {
	out := new(Success)
	err := c.cc.Invoke(ctx, "/Network/Ban", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type NetworkServer interface {
	...
	Add(context.Context, *IP) (*Success, error)
	Ban(context.Context, *IP) (*Success, error)
}
...
func (*UnimplementedNetworkServer) Add(context.Context, *IP) (*Success, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Add not implemented")
}
func (*UnimplementedNetworkServer) Ban(context.Context, *IP) (*Success, error) {
...
func _Network_Add_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(IP)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(NetworkServer).Add(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Network/Add",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NetworkServer).Add(ctx, req.(*IP))
	}
	return interceptor(ctx, in, info, handler)
}

func _Network_Ban_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(IP)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(NetworkServer).Ban(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Network/Ban",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NetworkServer).Ban(ctx, req.(*IP))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Network_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Add",
			Handler:    _Network_Add_Handler,
		},
		{
			MethodName: "Ban",
			Handler:    _Network_Ban_Handler,
		},
	},
